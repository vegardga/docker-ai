...
Vi snakker om kraftige, ikke-deterministiske og rimelig avanserte verktøy her. Blir vi blendet av de potensielle superkreftene disse verktøyene gir oss og det at alle rundt deg roper "du må komme i gang _nå_!", at vi ikke klarer å vurdere konsekvensene og risikoen ved valgene vi tar?
...
«Excuse me, mr Big Boss from large AI company, but your AI just deleted my entire home directory and fucked up my computer. Could you help me please?». 
...
Hvis du nå er en som tenker "hvorfor Docker, og ikke f.eks. Podman?". Vel, godt spørsmål, da Podman er enda bedre med tanke på sikkerhet. Podman kan ikke kjøres som root, så dette får du gratis med på kjøpet! Jeg vil uansett påstå at Docker, med tilhørende tooling, er mer utbredt og "kjent" rundt om enn Podman. I hvert fall der jeg har jobbet. Og poenget jeg vil få fram forblir det samme - nemlig at vi pakker AI'en inn i en sandkasse med begrensede rettigheter og tilganger.

Anyway, hvis du ikke allerede har installert Docker (eller Podman) må du først gjøre det. Følg instruksjonene på nettsidene til f.eks. (Docker - Get Started)[https://www.docker.com/get-started/], eller be din allerede-installerte-AI-som-enn-så-lenge-kjører-som-deg-med-dine-rettigheter-og-tilganger-venn om hjelp :man-shrugged: :joy:
...
Da har Jimmy opprettet tre AI-containere, som alle er klar for jobb! For å kickstarte AI'en med oppgaven den skal løse går Jimmy inn i den respektive AI-containeren, og skriver en fyldig spørring med konteksen han tror AI'en trenger for å løse oppgaven best mulig.
...
Du velger selv hva du gjør videre - men jeg ber deg tenke deg nøye om rundt hva du installerer og hva du gir tilgang til. Det er som sagt superverktøy du tar i bruk - og med det følger det stort ansvar i et hav av muligheter. Ha det gøy, lek og lær, men bruk hodet!
